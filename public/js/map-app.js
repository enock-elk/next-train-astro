 ...
 */
        ...
        const STATION_COORDINATES = {
            ...
            "HARTBEESSPRUIT": [-25.746516, 28.241152],
            ...
            "SCHUTTESTRAAT": [-25.750415, 28.159815],
            ...
            "LUIPAARDSVLEI": [-26.119650, 27.811365],
            ...
            "STIKLAND": [-33.904770, 18.656536],
            "BRACKENFELL": [-33.880927, 18.688698],
            "EIKENFONTEIN": [-33.857150, 18.711159],
            "KRAAIFONTEIN": [-33.846888, 18.724424],
            "FISANTKRAAL": [-33.786264, 18.711699],
        ...
        const STATIC_ROUTE_PATHS = {
            ...
            'pta-dewildt': ["PRETORIA", "PRETORIA-B", "PRETORIA WES", "HERCULES", "DASPOORT", "MOUNTAIN VIEW", "WONDERBOOM", "PRETORIA-N", "WOLMERTON", "WINTERSNEST", "ROSSLYN", "GA-RANKUWA", "TAILLARDSHOOP", "DE WILDT"],
            'herc-koed': ["HERCULES", "CAPITAL PARK", "GEZINA", "DEERNESS", "VILLIERIA", "PIERNEEFSRUS", "QUEENSWOOD", "KOEDOESPOORT"],
            'pta-saul': ["PRETORIA", "PRETORIA WES", "MITCHELLSTRAAT", "KALAFONG", "ATTERIDGEVILLE", "SAULSVILLE"],
            ...
            'jhb-soweto': ["JOHANNESBURG", "BRAAMFONTEIN", "MAYFAIR", "GROSVENOR", "LANGLAAGTE", "LONGDALE", "NEW CANADA", "MZIMHLOPE", "PHOMOLONG", "PHEFENI", "DUBE", "IKWEZI", "INHLAZANE", "MERAFE", "NALEDI"],
        ...
        const KZN_BRIDGE_CITY_MAIN = ["BEREA ROAD", "DURBAN", "MOSES MABHIDA", "UMGENI", "BRIARDENE", "GREENWOOD PARK", "RED HILL", "AVOCA", "DUFF'S ROAD", "BRIDGE CITY"];
        ...
        function bakedLineFor(routeId, trackBundle) {
            if (trackEdit && trackEdit.routeId === routeId && trackEdit.goldCoords && trackEdit.goldCoords.length > 1) {
                return trackEdit.goldCoords;
            }
            const gold = trackBundle?.goldById?.get(routeId);
            if (gold && gold.length > 1) return gold;
            return trackBundle?.byId?.get(routeId);
        }
        ...
        function resolveStopsLatLngs(stops, routeObj, trackBundle, preferBakeId) {
            ...
            const bakedId = preferBakeId || routeObj.routeId;
            ...
            if (routeObj.routeId === 'kzn-bridgecity' && !preferBakeId && baked) {
        ...
        async function initDynamicMap() {
            ...
            function paintRouteLines(trackBundle) {
                ...
                `;
                    ...
                    const spurCoords = resolveNoluKapteinsklipSpurLatLngs(r, trackBundle)
                        || resolveKznKwamashuSpurLatLngs(r, trackBundle);
            ...
            function startTrackEditor() {
                ...
                const gold = cloneLatLngs((liveTrackBundle.goldById && liveTrackBundle.goldById.get(r.routeId)) || liveTrackBundle.byId.get(r.routeId));
