/**
 * Runtime checks for V8_08.16.1 live line: leftover 0619 default, sim weekday date, region picker guard.
...
assert(APP_VERSION === 'V8_08.16.1', `APP_VERSION is ${APP_VERSION}`);
assert(
...
console.log('\nAll live-line debug-fix checks passed');
