...
assert(APP_VERSION === 'V8_08.27.4', `APP_VERSION ${APP_VERSION}`);
assert(CHANGELOG_DATA[0].id === 'V8_08.27.4' && CHANGELOG_DATA[0].features.length === 3, 'What’s New latest card is V8_08.27.4');
