...
assert(APP_VERSION === 'V9_08.28.10', `APP_VERSION ${APP_VERSION}`);
...
assert(CHANGELOG_DATA[0].id === 'V9_08.28.10' && CHANGELOG_DATA[0].features.length === 2, 'What’s New latest card is V9_08.28.10');
assert(CHANGELOG_DATA[1].id === 'V9_08.28.9', 'keep V9_08.28.9 as the previous What’s New card');
assert(CHANGELOG_DATA[2].id === 'V9_08.28.8', 'keep V9_08.28.8 as the previous What’s New card');
assert(CHANGELOG_DATA[3].id === 'V9_08.28.7', 'keep V9_08.28.7 as the previous What’s New card');
assert(CHANGELOG_DATA[4].id === 'V9_08.28.2', 'V9_08.28.6–28.3 folded into V9_08.28.2');
assert(CHANGELOG_DATA[5].id === 'V9_08.28.1', 'keep V9_08.28.1 as the previous production What’s New card');
...
assert(CHANGELOG_DATA[4].features.some((f) => f.includes('oval bar')), 'folded 28.2 card still mentions floating tabs');
