...
assert(APP_VERSION === 'V8_08.27.3', `APP_VERSION ${APP_VERSION}`);
assert(CHANGELOG_DATA[0].id === 'V8_08.27.3' && CHANGELOG_DATA[0].features.length === 4, 'What’s New latest card is V8_08.27.3');
