...
import {
    ...
    ADMIN_EMAILS, isAdminEmail, COMMUNITY_WORKER_URL, COMMUNITY_WORKER_FALLBACK_URL,
...
import { ADMIN_CHANGELOG, lookupAdminChangelog, listAdminChangelogVersions, normalizeAdminChangelogKey } from './admin-changelog.js';
...
export function exposeAdminGlobals() {
    ...
    window.COMMUNITY_WORKER_URL = COMMUNITY_WORKER_URL || COMMUNITY_WORKER_FALLBACK_URL;
    ...
    window.normalizeAdminChangelogKey = normalizeAdminChangelogKey;
