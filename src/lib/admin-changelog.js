...
export const ADMIN_CHANGELOG = {
    'V9_09.19.8': [
        'Auto-locate is startup-only: init, Welcome close, and an unconsumed pageshow. Route change, schedule load, tab change, and visibility no longer kick GPS. populateStationList still clears a station that is not on the new corridor, but the empty board is no longer filled by a silent locate. Options → Find nearest station (default on, nt_auto_locate) turns the startup pass off. Locate button stays manual. No What’s New. forceShow stays false. FORCE_UPDATE_REQUIRED stays true.',
    ],
    'V9_09.19.7': [
