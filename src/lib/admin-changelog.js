...
export const ADMIN_CHANGELOG = {
    'V9_09.17.15': [
        'Applied operator gold-track patches into public/tracks: GP pta-dewildt (121→131 verts, station list unchanged), herc-koed (214→218; bake now HERCULES > CAPITAL PARK > GEZINA > DEERNESS > VILLIERIA > PIERNEEFSRUS > QUEENSWOOD > KOEDOESPOORT), germ-kwesine (340 verts, station list unchanged), pta-saul (402 verts; MITCHELLSTRAAT added between Pretoria Wes and Kalafong), jhb-soweto (full Park Station to Naledi gold, 558 verts; JOHANNESBURG > BRAAMFONTEIN > MAYFAIR > GROSVENOR > LANGLAAGTE > … > NALEDI). KZN kzn-bridgecity (1095→980 verts; Duff’s Road / kwaMashu / Bridge City station list unchanged). fill-chords / smooth / audit stay held. No What’s New. forceShow stays false. FORCE_UPDATE_REQUIRED stays true.',
    ],
    'V9_09.17.14': [
