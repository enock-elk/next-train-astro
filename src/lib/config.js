 ...
 */
export const APP_VERSION = "V9_09.18.8";
...
export const LEGAL_TEXTS = {
    ...
    privacy: `
        ...
        <p class="mb-3"><strong>Location Data:</strong> If you allow location, Next Train may pick the nearest station on the live board. Coordinates stay on your device. We never transmit, track, or store your physical location on our servers.</p>
