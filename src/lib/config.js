 ...
 */
export const APP_VERSION = "V8_08.16.1";
...
export const CHANGELOG_DATA = [
    {
        id: "V8_08.16.1",
        title: "Timetable and region pick",
        date: "16 Aug 2026",
        ...
        features: [
            ...
            "<b>Full timetable:</b> The Mon–Fri grid matches the live service list, so a train is only marked no-service when it is actually cancelled."
        ]
    },
    {
        id: "V8_08.15.1",
