 ...
 */
export const APP_VERSION = "V9_09.26.1";
...
export const FARE_CONFIG = {
    ...
    // Detailed ticket table. Monthly amounts are the V5 zone table.
    zones_detailed: {
...
export const CHANGELOG_DATA = [
    {
        ...
        forceShow: false,
        features: [
            "Special trains for the day show on the Next Train board and Trip Planner when they run."
        ]
    },
    {
        id: "V9_09.24.9",
        title: "Timetable heading",
        date: "24 Sep 2026",
        forceShow: false,
        features: [
    ...
    {
        id: "V9_09.24.8",
        title: "Ticket Prices card",
        date: "24 Sep 2026",
        forceShow: false,
        features: [
            "Ticket Prices uses the same dark card as Next Train.",
            "Check for Updates keeps your pinned route."
        ]
    },
    {
        id: "V9_09.24.5",
        title: "Ticket Prices on a dark screen",
        date: "24 Sep 2026",
        forceShow: false,
        features: [
    ...
    {
        id: "V9_09.24.4",
        title: "Holiday day line",
        date: "24 Sep 2026",
        forceShow: false,
        features: [
            "The day line shows the holiday timetable straight away.",
            "A public holiday with no trains names that day.",
            "Trip Planner names the public holiday timetable.",
            "A public holiday train sheet says Public Holidays."
        ]
    },
    {
        id: "V9_09.24.3",
    ...
    },
    {
        ...
        forceShow: false,
        features: [
            "Opening the app goes from the splash screen to the board. If startup takes longer, Starting Next Train stays on screen."
        ]
    },
    {
        id: "V9_09.20.2",
        title: "Trip fare tickets",
        date: "20 Sep 2026",
        forceShow: false,
        features: [
    ...
    },
    {
        ...
        forceShow: false,
        features: [
            "Ads at the top of the board scroll away with the page."
        ]
    },
    {
        id: "V9_09.17.14",
        title: "Ticket Prices note",
        date: "17 Sep 2026",
        forceShow: false,
        features: [
            "Ticket Prices on the board: outside Zone 1, shorter trips may cost less. Confirm at the station."
        ]
    },
    {
        id: "V9_09.17.10",
    ...
    },
    {
        ...
        forceShow: false,
        features: [
            "Check for Updates downloads the latest app onto this phone, then restarts Next Train. Your pinned route stays, but the look goes back to Classic light.",
            "Feedback Hub sits flush at the bottom. Typing a message stays above the keyboard."
        ]
    },
    {
        id: "V9_09.16.2",
        title: "Nolungile to Kapteinsklip",
        date: "16 Sep 2026",
        forceShow: false,
        features: [
            "Cape Town to Nolungile also follows the line through Lentegeur and Mitchell's Plain, ending at Kapteinsklip."
        ]
    },
    {
        id: "V9_09.16.1",
    ...
    },
    {
        ...
        forceShow: false,
        features: [
            "<b>Planner:</b> Station choices open at the top while you type.",
            "<b>Tabs:</b> The oval bar stays at the bottom while the keyboard is open.",
            "<b>Options:</b> Feedback Hub sits against the keyboard when you write a message."
        ]
    },
    {
        id: "V9_08.28.14",
    ...
    },
    {
        ...
        forceShow: false,
        features: [
            "<b>Look:</b> Earthy Dark and Classic Light stay after an app update. Check for Updates in Options restores Classic light."
        ]
    },
    {
        id: "V9_08.28.11",
        title: "Map stations on the lines",
        date: "28 Aug 2026",
        forceShow: false,
        features: [
            "<b>Map:</b> Station dots sit on the lines. Network Lines uses the colour dots. Grey means that corridor is not live."
        ]
    },
    {
        id: "V9_08.28.10",
